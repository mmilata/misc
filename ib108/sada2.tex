...
\zadani{2}{1}
% celkem hodně zmatené (snad ne příliš)
% funkční (snad až na překlepy a off-by-one chyby)
% nesjednocené značení (nedotexované)
...
podposloupnosti, snadno určíme výsledek i pro~jejich sloučení. Invariantem
algoritmu je struktura pole studentů. Pokud pole obsahuje, alespoň $\ceil{N}{2}$
