...
řádcích 3 až 25. Tři cykly for zajistí postupné projití skupin podle vzrůstajícího $s_1+s_2+s_3$,
...
Na řádcích 26 až 37 se pak z tabulky $G$ vytvoří pole $Res$, kde $Res[st]$ obsahuje číslo skupiny,
