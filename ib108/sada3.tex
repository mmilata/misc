...
%Inicializace sítě je podobná hledání optimálního toku, nicméně na jejím konci získáme tok, který
%nemusí být minimální. Rozdíl je také v tom, že místo cesty hledáme tah (posloupnost
%\uv{navazujících} hran, ve které se žádná hrana neopakuje) místo cesty. To se děje z toho důvodu, že
%ačkoliv máme zaručeno, že každý vrchol leží na cestě z $s$ do $t$, o hranách to obecně platit
%nemusí, protože mohou ležet na cyklu a nebýt součástí žádné cesty z $s$ do $t$; nicméně na nějakém
%tahu už ležet musí.
...
$|E|$-krát, vnitřní nejvýše $2|V|$-krát, řádek č.1 zabere $|V|^2$ operací; algoritmus je tedy v
$\O(|E||V| + |V|^2)$.
...
vylepšením cesty pak rozumíme odečtením nejmenší reziduální kapacity od všech hran na této cestě.
...
\WHILE{existuje zlepšující cesta}
...
cykly cykly cykly a hlavne {\Huge{dukaz}}
